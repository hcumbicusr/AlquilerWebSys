...
}else
{
    ...
    echo "<br><a  id='linkValXLS_all' class='btn btn-default' href='../../reportes/rep_valorizacion_acumulada_det_xls.php?cliente=".$_POST['id']."&desde=".$_POST['desde']."&hasta=".$_POST['hasta']."' target='_blank'>Ver valorización Detallada (EXCEL)</a>";
}
