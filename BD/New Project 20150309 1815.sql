...
INSERT INTO `abastecimiento` (`id_abastecimiento`,`id_tipocomprobante`,`id_tipocombustible`,`fecha`,`nro_comprobante`,`nro_operacion_ch`,`abastecedor`,`cantidad`,`precio_u`,`total`,`cantidad_guia`) VALUES 
 (1,1,1,'2014-12-31 00:00:00','003-0077170','TRANSFERENCIA','ABASTECEDOR A','3720.00','13.02','48434.40','0.00');
...
INSERT INTO `cliente` (`id_cliente`,`id_tipocliente`,`codigo`,`nombre`,`direccion`,`telefono`,`estado`,`f_registro`) VALUES 
 ...
 (2,2,'2013203040','CLIENTE B','PIURA - PIURA - PIURA','073473647','A','2015-03-03 00:33:54'),
...
INSERT INTO `contrato` (`id_contrato`,`id_obra`,`id_cliente`,`f_inicio`,`f_fin`,`presupuesto`,`detalle`,`estado`) VALUES 
 (1,1,1,'2014-12-01 00:00:00','2015-03-08 00:00:00','25000.00','','A'),
 (2,2,2,'2014-12-01 00:00:00','2015-01-31 00:00:00','65000.00','','A'),
 (3,3,2,'2014-12-06 00:00:00','2014-12-31 00:00:00','64500.00','','A');
...
INSERT INTO `detalleabastecimiento` (`id_detalleabastecimiento`,`id_abastecimiento`,`id_tipocombustible`,`id_vehiculo`,`id_trabajador`,`fecha`,`nro_guia`,`cantidad`,`stock`,`abastecedor`) VALUES 
 ...
 (21,0,1,38,17,'2014-12-22 00:00:00','001-014893','150.00','62.80','ABASTECEDOR A'),
 ...
 (25,0,1,38,17,'2014-12-27 00:00:00','001-014915','80.00','15.10','ABASTECEDOR A'),
 (26,0,1,38,17,'2014-12-31 00:00:00','001-014923','200.00','90.50','ABASTECEDOR A');
...
INSERT INTO `obra` (`id_obra`,`id_tipoobra`,`nombre`,`fecha`,`estado`) VALUES 
 ...
 (4,1,'EXCAVACIÓN PARA TUBERÍA','2015-03-03 00:12:35','A');
...
INSERT INTO `tipotrabajador` (`id_tipotrabajador`,`nombre`) VALUES 
 (2,'CONTROLADOR'),
 (1,'OPERARIO');
...
INSERT INTO `usuario` (`id_usuario`,`id_trabajador`,`id_tipousuario`,`nombre`,`clave`,`estado`,`f_registro`,`f_modificacion`,`f_ultimo_acceso`,`f_cierre_sesion`,`cambio_clave`) VALUES 
 (1,1,3,'admin','e10adc3949ba59abbe56e057f20f883e','A','2015-02-08 14:43:51','2015-03-09 02:40:06','2015-03-09 16:00:34','2015-03-09 02:44:46',1),
 ...
 (18,18,2,'emontero85','e10adc3949ba59abbe56e057f20f883e','A','2015-03-07 21:30:50','2015-03-07 21:44:08','2015-03-09 09:47:20','2015-03-09 14:59:26',0);
...
INSERT INTO `vehiculo` (`id_vehiculo`,`id_marca`,`id_tipovehiculo`,`nombre`,`modelo`,`serie`,`motor`,`color`,`placa`,`estado`,`horometro_ac`,`kilometraje_ac`,`precio_alq`) VALUES 
 (1,1,1,'TRACTOR SOBRE ORUGAS','D7G','92E-2876','55-6777',' ',' ','C','2034.00','1234.00','240.00'),
 (2,9,4,'CAMIONETA',' ',' ',' ',' ','B4J-831','A','0.00','0.00','240.00'),
 (3,1,1,'EXCAVADORA SOBRE ORUGAS Nro 01','320 C','0FBA-01122','7JK-59396',' ',' ','A','0.00','0.00','240.00'),
 (4,1,1,'EXCAVADORA SOBRE ORUGAS Nro 02','320 C','0FBA-03503','07JK-05242',' ',' ','C','2865.70','0.00','240.00'),
 (5,1,1,'EXCAVADORA SOBRE ORUGAS Nro 03','320 CL','SBN02008','MAE10063',' ',' ','A','2065.50','1500.00','240.00'),
 (6,1,1,'EXCAVADORA SOBRE ORUGAS Nro 04','324 DL','DFP01154','KHX41907',' ',' ','C','4722.40','0.00','240.00'),
 (7,1,1,'EXCAVADORA SOBRE ORUGAS Nro 01','336DL','M4T01576','THX37070',' ',' ','A','0.00','0.00','240.00'),
 (8,1,1,'EXCAVADORA SOBRE ORUGAS Nro 02','336DL','M4T01252','THX34817',' ',' ','A','0.00','0.00','240.00'),
 (9,1,1,'TRACTOR SOBRE ORUGAS Nro 01','D7RII','0AEC01830','07ZR23926',' ',' ','C','12841.00','0.00','240.00'),
 (10,1,1,'TRACTOR SOBRE ORUGAS Nro 02','D7RII','0AEC02001','07ZR24462',' ',' ','A','2345.60','3452.50','240.00'),
 (12,1,1,'TRACTOR SOBRE ORUGAS Nro 03','D7RII','0AEC01909','07ZR24215',' ',' ','A','34900.00','0.00','240.00'),
 (13,1,1,'TRACTOR SOBRE ORUGAS Nro 01','D8T','J8B03317','TXG05157',' ',' ','A','0.00','0.00','240.00'),
 (14,1,1,'TRACTOR SOBRE ORUGAS Nro 02','D8T','J8B03072','TXG03883',' ',' ','A','0.00','0.00','240.00'),
 (15,2,1,'TRACTOR SOBRE ORUGAS C/RIPPER','FD9-FA-120','8065.25.096','',' ',' ','C','642.20','0.00','240.00'),
 (16,1,1,'RETROEXCAVADORA Nro 01','420D','FDP18886','CRS01348',' ',' ','A','0.00','0.00','240.00'),
 (17,1,1,'RETROEXCAVADORA Nro 02','420D','FDP25583','CRS28385',' ',' ','A','252.30','0.00','240.00'),
 (18,2,1,'TRACTOR AGRÍCOLA Nro 01','7066DT','286218',' ',' ',' ','A','0.00','0.00','240.00'),
 (19,2,1,'TRACTOR AGRÍCOLA Nro 03','7066DT','8045-06','*071343*',' ',' ','D','0.00','0.00','240.00'),
 (20,2,1,'TRACTOR AGRÍCOLA Nro 04','7066DT','8045-06','*307-454287*',' ',' ','A','0.00','0.00','240.00'),
 (21,1,1,'CARGADOR FRONTAL','938H','JKM01803','G9G04934',' ',' ','A','23006.00','1200.00','240.00'),
 (22,8,3,'CAMIÓN',' ',' ','',' ','P2U-886','A','0.00','0.00','240.00'),
 (23,3,3,'CAMIÓN',' ',' ','',' ','P2W-828','C','233653.00','0.00','240.00'),
 (24,4,4,'CAMIONETA',' ',' ','',' ','P2W-833','A','0.00','0.00','240.00'),
 (25,4,4,'CAMIONETA',' ',' ','',' ','P2K-786','C','71609.00','0.00','240.00'),
 (26,4,4,'CAMIONETA',' ',' ','',' ','P3C-771','C','660.00','0.00','240.00'),
 (27,3,4,'CAMIONETA',' ',' ','',' ','P2G-253','A','0.00','0.00','240.00'),
 (28,7,4,'CAMIONETA',' ',' ','',' ','P2J-926','A','0.00','0.00','240.00'),
 (29,3,4,'CAMIONETA',' ',' ','',' ','P1N-388','A','0.00','0.00','240.00'),
 (30,3,4,'CAMIONETA',' ',' ','',' ','P1L-247','A','0.00','0.00','240.00'),
 (31,4,4,'CAMIONETA',' ',' ','',' ','P2F-772','A','0.00','0.00','240.00'),
 (32,5,3,'CAMIÓN',' ',' ','',' ','P3G-742','A','0.00','0.00','240.00'),
 (33,5,3,'CAMIÓN',' ',' ','',' ','P3D-898','D','0.00','0.00','240.00'),
 (34,5,3,'CAMIÓN',' ',' ','',' ','P3D-885','A','0.00','0.00','240.00'),
 (35,6,3,'CAMIÓN',' ',' ','',' ','AAY-840','A','0.00','0.00','240.00'),
 (36,6,3,'CAMIÓN',' ',' ','',' ','ABA-852','A','0.00','0.00','240.00'),
 (37,6,2,'REMOLCADOR',' ',' ','',' ','AAO-915','A','0.00','0.00','240.00'),
 (38,3,5,'VECHÍCULO SURTIDOR','SURTIDOR','SURTID','SURTID','SURTID','P3H-833','G','0.00','0.00','240.00'),
 (42,2,1,'TRACTOR AGRÍCOLA Nro 02','7066DT','286218',' ',' ',' ','A','0.00','0.00','240.00'),
 (43,1,5,'VECHÍCULO SURTIDOR','SURT','SURTIDOR','SURTIDOR','SURTIDOR','P3H-833','A','0.00','0.00','240.00');
...
CASE lower(tabla)
  ...
  when 'estado' THEN SELECT id_estado as id, nombre FROM estado;
...
CASE tabla_i
WHEN 'ARTICULO' THEN SELECT * FROM tipoarticulo;
WHEN 'CLIENTE' THEN SELECT * FROM tipocliente;
WHEN 'COMBUSTIBLE' THEN SELECT id_tipocombustible,nombre,estado FROM tipocombustible;
WHEN 'COMPROBANTE' THEN SELECT * FROM tipocomprobante;
WHEN 'OBRA' THEN SELECT * FROM tipoobra;
WHEN 'TRABAJADOR' THEN SELECT id_tipotrabajador,nombre FROM tipotrabajador;
WHEN 'USUARIO' THEN SELECT id_tipousuario,nombre FROM tipousuario;
WHEN 'VEHICULO' THEN SELECT * FROM tipovehiculo;
WHEN 'MARCA' THEN SELECT * FROM marca;
END CASE;
...
AND substr(fecha,1,10) = substr(fecha_i,1,10)
...
#WHERE serie = upper(serie_i) or motor = upper(motor_i) or placa = upper(placa_i);
