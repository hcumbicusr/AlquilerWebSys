...
INSERT INTO `regs` (`id`,`id_usuario`,`fecha`,`accion`,`tablas_afectadas`,`ip_cliente`,`nav_cliente`,`so_cliente`) VALUES 
 ...
 (410,1,'2015-03-30 07:52:38','INICIO SESION: CORRECTO','USUARIO: ADMIN','::1','Google Chrome','Windows'),
 (411,1,'2015-03-30 08:00:14','INICIO SESION: CORRECTO','USUARIO: ADMIN','::1','Google Chrome','Windows'),
 (412,1,'2015-03-30 12:20:37','INICIO SESION: CORRECTO','USUARIO: ADMIN','192.168.5.23','Google Chrome','Linux');
...
INSERT INTO `usuario` (`id_usuario`,`id_trabajador`,`id_tipousuario`,`nombre`,`clave`,`estado`,`f_registro`,`f_modificacion`,`f_ultimo_acceso`,`f_cierre_sesion`,`cambio_clave`) VALUES 
 (1,1,3,'admin','e10adc3949ba59abbe56e057f20f883e','A','2015-02-08 14:43:51','2015-03-09 02:40:06','2015-03-30 12:20:37','2015-03-29 01:43:07',1),
...
LEFT JOIN consumo con ON d.id_detalleabastecimiento = con.id_detalleabastecimiento
...
WHERE d.fecha BETWEEN (f_desde-1) AND f_hasta
