...
INSERT INTO `detallealquiler` (`id_detallealquiler`,`id_contrato`,`id_vehiculo`,`id_articulo`,`precio_alq`,`fecha`,`estado`,`observacion`,`est_alq`) VALUES 
 ...
 (14,4,17,0,'240.00','2015-03-26 09:32:26','','TRABAJO SOBRE OBRA DE PRUEBA N1','B'),
 ...
 (18,4,27,0,'240.00','2015-03-26 09:32:26','','MOVILIDAD DEL INGENIERO A CARGO DE LA OBRA','B');
...
INSERT INTO `usuario` (`id_usuario`,`id_trabajador`,`id_tipousuario`,`nombre`,`clave`,`estado`,`f_registro`,`f_modificacion`,`f_ultimo_acceso`,`f_cierre_sesion`,`cambio_clave`) VALUES 
 (1,1,3,'admin','e10adc3949ba59abbe56e057f20f883e','A','2015-02-08 14:43:51','2015-03-09 02:40:06','2015-03-25 15:36:32','2015-03-26 09:51:04',1),
...
INSERT INTO `vehiculo` (`id_vehiculo`,`id_marca`,`id_tipovehiculo`,`nombre`,`modelo`,`serie`,`motor`,`color`,`placa`,`rendimiento`,`estado`,`horometro_ac`,`kilometraje_ac`,`precio_alq`) VALUES 
 ...
 (17,1,1,'RETROEXCAVADORA Nro 02','420D','FDP25583','CRS28385',' ',' ','0','D','1219.90','0.00','240.00'),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`diverc0l`@`localhost` PROCEDURE `sp_finalizar_contrato`(
in id_usuario_i int,
in ip varchar(16),
in nav varchar(50),
in so varchar(50),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`diverc0l`@`localhost` PROCEDURE `sp_REP_valorizacion_group_vehiculo_obra`(
in id_cliente_i int,
in desde date,
in hasta date,
in id_vehiculo_i int,
