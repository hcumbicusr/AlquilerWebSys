...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Listado de maquinaria en uso</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <a href="ct_list_clientes.php">
            ...
            <div class="panel panel-default">
                <?php 
                    ...
                    $query = "SELECT c.nombre as cliente,o.nombre as obra FROM cliente c "
                            ...
                            . "WHERE con.id_contrato = ".Funciones::decodeStrings($_GET['cliente'], 2); 
                    //die(var_dump($query));
                    $select = $objDB->selectManager()->select($con, $query);
                    ?>
                <div class="panel-heading">                    
                    Maquinaria para control<br>
                ...
                <div class="panel-body table-responsive">
                    <div class="dataTable_wrapper">                        
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php 
                                require_once '../../libraries/HTML_tabla_control_vehiculos.php'; 
                                table($_GET['cliente']);
                                ?>
                            </tbody>
                        </table>                        
