...
<div id="page-wrapper">
    ...
    <a href="ct_list_vale_comb.php">
        <img src="../img/atras.png" title="Vales de combustible"><label>Atr&aacute;s</label>
    </a>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Editar compra de combustible para veh&iacute;culos<br>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <script LANGUAGE="JavaScript">
                                    var pagina="ct_list_vale_comb.php";
                            ...
                            $result = $objDB->selectManager()->spSelect($con, "sp_listar_guia_ID",  Funciones::decodeStrings($_GET['id'], 2));
                            ...
                            <form role="form"  onsubmit="return validarForm(this);" method="POST" 
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="nro_guia" name="nro_guia"  value="<?php echo $result[0]['nro_guia']; ?>" >
                                    <input type="hidden" name="id_det_abast" value="<?php echo $_GET['id']; ?>" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" title="<?php echo $result[0]['vehiculo']; ?>">
                                    <label>Nro de Placa de veh&iacute;culo <label style="color: #FF0000">(*)</label> </label>
                                    <input id="nro_placa_v" name="nro_placa_v" value="<?php echo $result[0]['placa']; ?>" class="form-control" placeholder="Nro Placa"  maxlength="20" required >
                                    <p id="nro_placa_v_Msg" class="help-block">El veh&iacute;culo al cual pertenece este n&uacute;mero de placa 
                                        debe estar registrado, de lo contrario no se podr&aacute; realizar el abastecimiento.</p>
                                </div>                                
                                <div class="form-group">
