...
<script>
        ...
        function validarForm(formulario) {            
            ...
            if (formulario.nro_valeReg.value.trim().length < 3)
            {
                formulario.nro_valeReg.focus();   
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Registro consumo de combustible para veh&iacute;culos</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Formulario de registro de compra de combustible para veh&iacute;culos<br>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <script LANGUAGE="JavaScript">
                                    var pagina="ct_abastecimiento_vh.php";
                            ...
                            <form id="frmRegGuia" role="form"  onsubmit="return validarForm(this);" method="POST" 
                                  action="./../../app/controllers/detalle_abastecimiento.php?event=registrar_vale_comb">
                                ...
                                <div class="form-group">
                                    ...
                                    <p id="msg_valeCombustible_reg" class="help-block">N&uacute;mero de Vale.</p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nro_placa_v" name="nro_placa_v" class="form-control" placeholder="Nro Placa"  maxlength="20" required >
