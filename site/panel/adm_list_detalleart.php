        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    $res = listarAlquilerVH(Funciones::decodeStrings($_GET['alquiler'],2));
                    
                    echo "Art&iacute;culos alquilados para: <b>(".$res[0]['cod_cli'].") ".$res[0]['cliente_cli']." / ".$res[0]['obra']."</b>"; 
                    ?>
                </div>
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>Nro</th>                                                                      
                                    <th>Veh&iacute;culo/Maquinaria</th>
                                    <th>Precio Hora</th>
